...
from scheduler_config_editor.model.json_config import JsonConfig  # change this to where JsonConfig actually lives
...
class TestUndoRedo(unittest.TestCase):
    ...
    def setUp(self):
        ...
        patcher2 = patch("scheduler_config_editor.model.json_config.load_config_from_file",
